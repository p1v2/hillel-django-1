...
class BookSerializer(serializers.ModelSerializer):
    ...
    def calculate_field(self, book):
        return f'This book is {book.name} it has {book.pages_count} pages, it author is {book.authors_string} ' \
               f'Made in {book.country} ' \
               f'The price is {book.price}$, Seller is {book.seller}'
